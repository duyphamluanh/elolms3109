...
if ($ADMIN->fulltree) {
    $name = 'format_eloflexsections/keepstateoversession';
    $title = get_string('keepstateoversession', 'format_eloflexsections');
    $description = get_string('keepstateoversession_desc', 'format_eloflexsections');
    $default = false;
