...
Feature: Using course in eloflexsections format
  ...
  @javascript
  Scenario: Add sections and activities to eloflexsections format with JS on
  ...
  Scenario: Add sections and activities to eloflexsections format with JS off
    Given I should see "First module"
    And I should see "Second module"
    And I log out
    When I log in as "student1"
  ...
  @javascript
  Scenario: Collapsing section in eloflexsections format
  ...
  @javascript
  Scenario: Collapsing section with subsections in eloflexsections format
    Given I add the "Navigation" block if not present
    And I open the "Recent activity" blocks action menu
    And I click on "Delete Recent activity block" "link"
    And I press "Yes"
